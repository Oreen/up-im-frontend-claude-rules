...
- Для единиц измерения CSS свойства line-height используй безразмерное (unitless) значение (например, 1.26)
- При написании CSS стилей не нужно указывать свойство "font-family", так как он уже задан у тега body.
- Медиа-выражения (@media) размещайте внутри CSS-классов, а не отдельно.
...
- Для ограничения ширины блоков используй глобальный класс .container, который уже имеет необходимые стили
...
- Для работы с датами используй библиотеку dayjs
